...
//  MovingBlock
//
//  Created by Peter Shi on 2019-12-04.
...
class StickmanView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        body.addLine(to: CGPoint(x: 50, y: 100))
        body.addLine(to: CGPoint(x: 40, y: 120))
        body.move(to: CGPoint(x: 50, y: 100))
        body.addLine(to: CGPoint(x: 60, y: 120))
