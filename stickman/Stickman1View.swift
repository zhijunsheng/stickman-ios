...
class Stickman1View: UIView {
    ...
    func drawLeftArm() {
        ...
        pen.addLine(to: CGPoint(x: 90 - 33, y: 90 + 20))

        pen.move(to: CGPoint(x: 90 - 33, y: 90 + 20))
    ...
    func drawRighArm() {
        let pen = UIBezierPath()
        pen.move(to: CGPoint(x: 90, y: 90 + 30))
        pen.addLine(to: CGPoint(x: 90 + 33, y: 90 + 70))

        pen.move(to: CGPoint(x: 90 + 33, y: 90 + 70))
